  ...
  return (
    <>
      <View style={styles.container}>
        <View style={styles.header}>{/* <ZoundLogoSvg /> */}</View>
        <View style={styles.section}>
          <Text>
            Synchroniser votre service de streaming préféré afin de profiter
            pleinement à notre expérience:{' '}
          </Text>
          <SecondaryButton
            text="Synchroniser"
            handleFunction={() => loginBottomSheetRef.current?.present()}
          />
